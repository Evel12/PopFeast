...
export default function Layout() {
  ...
  useEffect(()=>{
    if (sort === 'genres') setGenresOpen(true);
  }, [sort]);
  ...
  return (
    <div className="app-container">
      <header className="app-header">
        <div className="container app-header-inner">
          <div className="brand">
            ...
            <div>
              <div style={{fontSize:'1.15rem',fontWeight:700}}>PopFeast</div>
              <div className="muted" style={{fontSize:12,marginTop:2}}>Movies & Series Explorer</div>
            </div>
          </div>
      ...
      <main className="container fade-container" style={{padding:'26px 0 120px'}}>
        <Outlet />
      </main>
      <BottomNav />
    </div>
